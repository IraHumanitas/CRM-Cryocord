...
TRANSITION_ACTIONS = {
    (STATE_DRAFT, STATE_SALES_REVIEW): "Submit for Review",
    (STATE_SALES_REVIEW, STATE_PENDING_OPERATIONS_APPROVAL): "Submit for Operations Approval",
    (STATE_SALES_REVIEW, STATE_DRAFT): "Request Revision",
    (STATE_PENDING_OPERATIONS_APPROVAL, STATE_OPERATIONS_APPROVED): "Approve",
    (STATE_PENDING_OPERATIONS_APPROVAL, STATE_REJECTED): "Reject",
    (STATE_REJECTED, STATE_DRAFT): "Revise",
    (STATE_OPERATIONS_APPROVED, STATE_READY_FOR_STORAGE_AGREEMENT): "Mark Ready",
    (STATE_READY_FOR_STORAGE_AGREEMENT, STATE_COMPLETED): "Complete",
    (STATE_DRAFT, STATE_CANCELLED): "Cancel",
    (STATE_SALES_REVIEW, STATE_CANCELLED): "Cancel",
    (STATE_PENDING_OPERATIONS_APPROVAL, STATE_CANCELLED): "Cancel",
}
